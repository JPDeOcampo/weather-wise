...
export async function fetchCoordinates(latitude, longitude, timezone) {
    ...
    const dailyArray = ['weather_code', 'apparent_temperature_max', 'apparent_temperature_min', 'sunrise,sunset', 'uv_index_max', 'uv_index_clear_sky_max', 'rain_sum', 'precipitation_probability_max'];
