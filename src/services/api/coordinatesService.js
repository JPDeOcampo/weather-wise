...
export async function fetchCoordinates(latitude, longitude, timezone) {
    const currentArray = ['temperature_2m', 'relative_humidity_2m', 'is_day', 'rain', 'precipitation', 'weather_code', 'apparent_temperature', 'wind_speed_10m', 'wind_direction_10m', 'wind_gusts_10m', 'cloud_cover'];
    ...
    const dailyArray = ['weather_code', 'apparent_temperature_max', 'apparent_temperature_min', 'sunrise,sunset', 'uv_index_max', 'uv_index_clear_sky_max', 'rain_sum', 'precipitation_probability_max','daylight_duration'];
